...
// Content translations (keys = the English text above). Famous works use their established French/Russian titles.
const STRINGS={
fr:{
'Suprematism':'Suprématisme','Welcome to the gallery':'Bienvenue au musée',
'Famous paintings have lost their color. Tap or drag a paint into the bowl; a part paints itself when the match reaches 95%. This first one needs only <b>White</b> and <b>Black</b>.':'Des tableaux célèbres ont perdu leurs couleurs. Touchez ou glissez une peinture dans le bol : une partie se colore quand la correspondance atteint 95 %. Ce premier tableau ne demande que du <b>Blanc</b> et du <b>Noir</b>.',
'After <i>Suprematism</i> by Kazimir Malevich, 1915 (public domain)':'D’après <i>Suprématisme</i> de Kazimir Malevitch, 1915 (domaine public)',
'Black square':'Carré noir','Canvas':'Toile','Gray bar':'Barre grise','Composition':'Composition',
'After <i>Composition with Red, Blue and Yellow</i> by Piet Mondrian, 1930 (public domain)':'D’après <i>Composition avec rouge, bleu et jaune</i> de Piet Mondrian, 1930 (domaine public)',
'Red square':'Carré rouge','White blocks':'Blocs blancs','Blue block':'Bloc bleu','Yellow block':'Bloc jaune','Black lines':'Lignes noires',
'Concentric Circles':'Cercles concentriques','After <i>Squares with Concentric Circles</i> by Wassily Kandinsky, 1913 (public domain)':'D’après <i>Carrés avec cercles concentriques</i> de Vassily Kandinsky, 1913 (domaine public)',
'Night blue':'Bleu nuit','Ochre':'Ocre','Teal':'Bleu canard','Crimson':'Cramoisi','Sky blue':'Bleu ciel','Violet':'Violet','Lemon':'Citron','Black':'Noir',
'Red Fuji':'Fuji rouge','After <i>Fine Wind, Clear Morning</i> by Katsushika Hokusai, c. 1831 (public domain)':'D’après <i>Vent frais par matin clair</i> de Katsushika Hokusai, vers 1831 (domaine public)',
'Upper sky':'Haut du ciel','Lower sky':'Bas du ciel','Clouds':'Nuages','Snow':'Neige','Lower slope':'Bas de la pente','Forest':'Forêt',
'Castle and Sun':'Château et soleil','After <i>Castle and Sun</i> by Paul Klee, 1928 (public domain)':'D’après <i>Château et soleil</i> de Paul Klee, 1928 (domaine public)',
'Brick':'Brique','Apricot':'Abricot','Rose':'Rose','Moss':'Mousse','Sand':'Sable','Towers':'Tours','Sun':'Soleil',
'Starry Night':'Nuit étoilée','After <i>The Starry Night</i> by Vincent van Gogh, 1889 (public domain)':'D’après <i>La Nuit étoilée</i> de Vincent van Gogh, 1889 (domaine public)',
'Stars':'Étoiles','Moon':'Lune','Hills':'Collines','Wind swirls':'Tourbillons de vent','Village':'Village','Cypress tree':'Cyprès','Night sky':'Ciel nocturne',
'Japanese Bridge':'Pont japonais','After <i>Bridge over a Pond of Water Lilies</i> by Claude Monet, 1899 (public domain)':'D’après <i>Pont sur un bassin de nymphéas</i> de Claude Monet, 1899 (domaine public)',
'Foliage':'Feuillage','Willows':'Saules','Pond':'Bassin','Reflections':'Reflets','Lily pads':'Feuilles de nénuphar','Lilies':'Nymphéas','Bridge':'Pont',
'The Scream':'Le Cri','After <i>The Scream</i> by Edvard Munch, 1893 (public domain)':'D’après <i>Le Cri</i> d’Edvard Munch, 1893 (domaine public)',
'Flaming sky':'Ciel embrasé','Orange sky':'Ciel orange','Yellow sky':'Ciel jaune','Fjord':'Fjord','Coat':'Manteau','Face':'Visage',
'The Great Wave':'La Grande Vague','After <i>The Great Wave off Kanagawa</i> by Katsushika Hokusai, c. 1831 (public domain)':'D’après <i>La Grande Vague de Kanagawa</i> de Katsushika Hokusai, vers 1831 (domaine public)',
'Sky':'Ciel','Mount Fuji':'Mont Fuji','Deep wave':'Vague profonde','Light wave':'Vague claire','Boats':'Barques','Foam':'Écume',
'Sunflowers':'Tournesols','After <i>Sunflowers</i> by Vincent van Gogh, 1888 (public domain)':'D’après <i>Les Tournesols</i> de Vincent van Gogh, 1888 (domaine public)',
'Wall':'Mur','Table':'Table','Leaves':'Feuilles','Vase':'Vase','Bright petals':'Pétales vifs','Orange petals':'Pétales orangés','Pale petals':'Pétales pâles','Seed heads':'Cœurs',
'Shapes and lines':'Formes et lignes','Sun and stars':'Soleil et étoiles','Water and sky':'L’eau et le ciel','The yellow room':'La salle jaune',
'Malevich built his Suprematist paintings from nothing but simple geometric shapes on a white ground.':'Malevitch construisait ses tableaux suprématistes uniquement avec des formes géométriques simples sur fond blanc.',
'Kazimir Malevich':'Kazimir Malevitch','Composition with Red, Blue and Yellow':'Composition avec rouge, bleu et jaune',
'Mondrian limited himself to the three primary colors, plus black, white and gray.':'Mondrian se limitait aux trois couleurs primaires, plus le noir, le blanc et le gris.',
'Piet Mondrian':'Piet Mondrian','De Stijl':'De Stijl','Kunsthaus Zürich':'Kunsthaus de Zurich','Netherlands':'Pays-Bas',
'Squares with Concentric Circles':'Carrés avec cercles concentriques',"It's a small color study on paper, not a large canvas.":'C’est une petite étude de couleur sur papier, pas une grande toile.',
'Wassily Kandinsky':'Vassily Kandinsky','Abstract art':'Art abstrait','Lenbachhaus, Munich':'Lenbachhaus, Munich','Russia':'Russie',
'Fine Wind, Clear Morning (Red Fuji)':'Vent frais par matin clair (Fuji rouge)','It belongs to the series Thirty-six Views of Mount Fuji, printed from carved wooden blocks.':'Elle fait partie de la série des Trente-six vues du mont Fuji, imprimée à partir de planches de bois gravées.',
'Katsushika Hokusai':'Katsushika Hokusai','Ukiyo-e':'Ukiyo-e','Japan':'Japon',
'Klee was teaching at the Bauhaus art school in Germany when he painted it.':'Klee enseignait au Bauhaus, l’école d’art allemande, quand il l’a peint.','Paul Klee':'Paul Klee',
'The Starry Night':'La Nuit étoilée','Van Gogh painted it from memory of the view from his window at the asylum in Saint-Rémy-de-Provence.':'Van Gogh l’a peinte de mémoire, d’après la vue de sa fenêtre à l’asile de Saint-Rémy-de-Provence.',
'Vincent van Gogh':'Vincent van Gogh','Post-Impressionism':'Postimpressionnisme','Museum of Modern Art, New York':'Museum of Modern Art, New York',
'Bridge over a Pond of Water Lilies':'Pont sur un bassin de nymphéas','Monet had the pond and the Japanese-style bridge built in his own garden at Giverny.':'Monet a fait creuser le bassin et construire le pont japonais dans son propre jardin à Giverny.',
'Claude Monet':'Claude Monet','Impressionism':'Impressionnisme','The Met, New York':'Metropolitan Museum, New York','France':'France',
'Munch made several versions of The Scream, in paint, pastel and print.':'Munch a réalisé plusieurs versions du Cri, en peinture, au pastel et en gravure.',
'Edvard Munch':'Edvard Munch','Expressionism':'Expressionnisme','National Museum, Oslo':'Musée national, Oslo','Norway':'Norvège',
'The Great Wave off Kanagawa':'La Grande Vague de Kanagawa','Look closely: Mount Fuji sits small in the background, between the waves.':'Regardez bien : le mont Fuji se cache, tout petit, entre les vagues.',
'Van Gogh painted his sunflowers to decorate the room for his friend Paul Gauguin in Arles.':'Van Gogh a peint ses tournesols pour décorer la chambre de son ami Paul Gauguin à Arles.',
'Mona Lisa':'La Joconde',"It's painted on a poplar wood panel, not on canvas.":'Elle est peinte sur un panneau de peuplier, pas sur toile.',
'Leonardo da Vinci':'Léonard de Vinci','Renaissance':'Renaissance','Louvre, Paris':'Musée du Louvre, Paris','Italy':'Italie',
'Girl with a Pearl Earring':'La Jeune Fille à la perle',"It's a tronie, a study of a face, not a portrait of a known sitter.":'C’est une « tronie », une étude de visage, pas le portrait d’un modèle connu.',
'Johannes Vermeer':'Johannes Vermeer','Dutch Golden Age':'Siècle d’or néerlandais','Mauritshuis, The Hague':'Mauritshuis, La Haye',
'The Kiss':'Le Baiser','Klimt used real gold leaf on the canvas.':'Klimt a utilisé de la vraie feuille d’or sur la toile.','Gustav Klimt':'Gustav Klimt','Art Nouveau':'Art nouveau','Belvedere, Vienna':'Belvédère, Vienne','Austria':'Autriche',
'The Birth of Venus':'La Naissance de Vénus','Venus arrives on a giant scallop shell, blown ashore by the winds.':'Vénus arrive sur une immense coquille Saint-Jacques, poussée vers le rivage par les vents.',
'Sandro Botticelli':'Sandro Botticelli','Uffizi, Florence':'Galerie des Offices, Florence',
'Impression, Sunrise':'Impression, soleil levant','This painting gave the Impressionist movement its name.':'Ce tableau a donné son nom au mouvement impressionniste.','Musée Marmottan Monet, Paris':'Musée Marmottan Monet, Paris',
'The Night Watch':'La Ronde de nuit',"It isn't a night scene: darkened varnish earned it the nickname.":'Ce n’est pas une scène de nuit : c’est le vernis assombri qui lui a valu ce surnom.',
'Rembrandt':'Rembrandt','Rijksmuseum, Amsterdam':'Rijksmuseum, Amsterdam',
'Henri Matisse':'Henri Matisse','Pablo Picasso':'Pablo Picasso','Robert Delaunay':'Robert Delaunay','Pierre-Auguste Renoir':'Pierre-Auguste Renoir','Paul Cézanne':'Paul Cézanne','Paul Gauguin':'Paul Gauguin','Edgar Degas':'Edgar Degas','Georges Seurat':'Georges Seurat',
'Utagawa Hiroshige':'Utagawa Hiroshige','Kitagawa Utamaro':'Kitagawa Utamaro','Utagawa Kuniyoshi':'Utagawa Kuniyoshi','Raphael':'Raphaël','Titian':'Titien',
'Cubism':'Cubisme','Baroque':'Baroque','National Gallery, London':'National Gallery, Londres',"Musée d'Orsay, Paris":'Musée d’Orsay, Paris','Prado, Madrid':'Musée du Prado, Madrid','Spain':'Espagne','Germany':'Allemagne'
},
ru:{
'Suprematism':'Супрематизм','Welcome to the gallery':'Добро пожаловать в галерею',
'Famous paintings have lost their color. Tap or drag a paint into the bowl; a part paints itself when the match reaches 95%. This first one needs only <b>White</b> and <b>Black</b>.':'Знаменитые картины потеряли цвет. Нажмите на краску или перетащите её в миску: часть раскрасится, когда совпадение дойдёт до 95%. Для первой картины нужны только <b>белая</b> и <b>чёрная</b>.',
'After <i>Suprematism</i> by Kazimir Malevich, 1915 (public domain)':'По мотивам картины «Супрематизм» Казимира Малевича, 1915 (общественное достояние)',
'Black square':'Чёрный квадрат','Canvas':'Холст','Gray bar':'Серая полоса','Composition':'Композиция',
'After <i>Composition with Red, Blue and Yellow</i> by Piet Mondrian, 1930 (public domain)':'По мотивам картины «Композиция с красным, синим и жёлтым» Пита Мондриана, 1930 (общественное достояние)',
'Red square':'Красный квадрат','White blocks':'Белые блоки','Blue block':'Синий блок','Yellow block':'Жёлтый блок','Black lines':'Чёрные линии',
'Concentric Circles':'Концентрические круги','After <i>Squares with Concentric Circles</i> by Wassily Kandinsky, 1913 (public domain)':'По мотивам работы «Квадраты с концентрическими кругами» Василия Кандинского, 1913 (общественное достояние)',
'Night blue':'Ночной синий','Ochre':'Охра','Teal':'Сине-зелёный','Crimson':'Малиновый','Sky blue':'Небесно-голубой','Violet':'Фиолетовый','Lemon':'Лимонный','Black':'Чёрный',
'Red Fuji':'Красная Фудзи','After <i>Fine Wind, Clear Morning</i> by Katsushika Hokusai, c. 1831 (public domain)':'По мотивам гравюры «Южный ветер. Ясный день» Кацусики Хокусая, ок. 1831 (общественное достояние)',
'Upper sky':'Верх неба','Lower sky':'Низ неба','Clouds':'Облака','Snow':'Снег','Lower slope':'Нижний склон','Forest':'Лес',
'Castle and Sun':'Замок и солнце','After <i>Castle and Sun</i> by Paul Klee, 1928 (public domain)':'По мотивам картины «Замок и солнце» Пауля Клее, 1928 (общественное достояние)',
'Brick':'Кирпич','Apricot':'Абрикос','Rose':'Розовый','Moss':'Мох','Sand':'Песок','Towers':'Башни','Sun':'Солнце',
'Starry Night':'Звёздная ночь','After <i>The Starry Night</i> by Vincent van Gogh, 1889 (public domain)':'По мотивам картины «Звёздная ночь» Винсента ван Гога, 1889 (общественное достояние)',
'Stars':'Звёзды','Moon':'Луна','Hills':'Холмы','Wind swirls':'Вихри ветра','Village':'Деревня','Cypress tree':'Кипарис','Night sky':'Ночное небо',
'Japanese Bridge':'Японский мостик','After <i>Bridge over a Pond of Water Lilies</i> by Claude Monet, 1899 (public domain)':'По мотивам картины «Мост над прудом с кувшинками» Клода Моне, 1899 (общественное достояние)',
'Foliage':'Листва','Willows':'Ивы','Pond':'Пруд','Reflections':'Отражения','Lily pads':'Листья кувшинок','Lilies':'Кувшинки','Bridge':'Мостик',
'The Scream':'Крик','After <i>The Scream</i> by Edvard Munch, 1893 (public domain)':'По мотивам картины «Крик» Эдварда Мунка, 1893 (общественное достояние)',
'Flaming sky':'Пылающее небо','Orange sky':'Оранжевое небо','Yellow sky':'Жёлтое небо','Fjord':'Фьорд','Coat':'Пальто','Face':'Лицо',
'The Great Wave':'Большая волна','After <i>The Great Wave off Kanagawa</i> by Katsushika Hokusai, c. 1831 (public domain)':'По мотивам гравюры «Большая волна в Канагаве» Кацусики Хокусая, ок. 1831 (общественное достояние)',
'Sky':'Небо','Mount Fuji':'Гора Фудзи','Deep wave':'Тёмная волна','Light wave':'Светлая волна','Boats':'Лодки','Foam':'Пена',
'Sunflowers':'Подсолнухи','After <i>Sunflowers</i> by Vincent van Gogh, 1888 (public domain)':'По мотивам картины «Подсолнухи» Винсента ван Гога, 1888 (общественное достояние)',
'Wall':'Стена','Table':'Стол','Leaves':'Листья','Vase':'Ваза','Bright petals':'Яркие лепестки','Orange petals':'Оранжевые лепестки','Pale petals':'Бледные лепестки','Seed heads':'Сердцевины',
'Shapes and lines':'Формы и линии','Sun and stars':'Солнце и звёзды','Water and sky':'Вода и небо','The yellow room':'Жёлтый зал',
'Malevich built his Suprematist paintings from nothing but simple geometric shapes on a white ground.':'Малевич строил свои супрематические картины только из простых геометрических фигур на белом фоне.',
'Kazimir Malevich':'Казимир Малевич','Composition with Red, Blue and Yellow':'Композиция с красным, синим и жёлтым',
'Mondrian limited himself to the three primary colors, plus black, white and gray.':'Мондриан ограничивался тремя основными цветами, а также чёрным, белым и серым.',
'Piet Mondrian':'Пит Мондриан','De Stijl':'Де Стейл','Kunsthaus Zürich':'Кунстхаус, Цюрих','Netherlands':'Нидерланды',
'Squares with Concentric Circles':'Квадраты с концентрическими кругами',"It's a small color study on paper, not a large canvas.":'Это небольшой цветовой этюд на бумаге, а не большое полотно.',
'Wassily Kandinsky':'Василий Кандинский','Abstract art':'Абстрактное искусство','Lenbachhaus, Munich':'Ленбаххаус, Мюнхен','Russia':'Россия',
'Fine Wind, Clear Morning (Red Fuji)':'Южный ветер. Ясный день (Красная Фудзи)','It belongs to the series Thirty-six Views of Mount Fuji, printed from carved wooden blocks.':'Она входит в серию «Тридцать шесть видов Фудзи», отпечатанную с резных деревянных досок.',
'Katsushika Hokusai':'Кацусика Хокусай','Ukiyo-e':'Укиё-э','Japan':'Япония',
'Klee was teaching at the Bauhaus art school in Germany when he painted it.':'Клее преподавал в немецкой школе искусств Баухаус, когда написал эту картину.','Paul Klee':'Пауль Клее',
'The Starry Night':'Звёздная ночь','Van Gogh painted it from memory of the view from his window at the asylum in Saint-Rémy-de-Provence.':'Ван Гог написал её по памяти, вспоминая вид из окна лечебницы в Сен-Реми-де-Прованс.',
'Vincent van Gogh':'Винсент ван Гог','Post-Impressionism':'Постимпрессионизм','Museum of Modern Art, New York':'Музей современного искусства, Нью-Йорк',
'Bridge over a Pond of Water Lilies':'Мост над прудом с кувшинками','Monet had the pond and the Japanese-style bridge built in his own garden at Giverny.':'Моне сам устроил пруд и японский мостик в своём саду в Живерни.',
'Claude Monet':'Клод Моне','Impressionism':'Импрессионизм','The Met, New York':'Метрополитен-музей, Нью-Йорк','France':'Франция',
'Munch made several versions of The Scream, in paint, pastel and print.':'Мунк создал несколько версий «Крика»: краской, пастелью и в печатной графике.',
'Edvard Munch':'Эдвард Мунк','Expressionism':'Экспрессионизм','National Museum, Oslo':'Национальный музей, Осло','Norway':'Норвегия',
'The Great Wave off Kanagawa':'Большая волна в Канагаве','Look closely: Mount Fuji sits small in the background, between the waves.':'Присмотритесь: маленькая гора Фудзи видна вдали, между волнами.',
'Van Gogh painted his sunflowers to decorate the room for his friend Paul Gauguin in Arles.':'Ван Гог писал подсолнухи, чтобы украсить комнату для своего друга Поля Гогена в Арле.',
'Mona Lisa':'Мона Лиза',"It's painted on a poplar wood panel, not on canvas.":'Она написана на тополевой доске, а не на холсте.',
'Leonardo da Vinci':'Леонардо да Винчи','Renaissance':'Возрождение','Louvre, Paris':'Лувр, Париж','Italy':'Италия',
'Girl with a Pearl Earring':'Девушка с жемчужной серёжкой',"It's a tronie, a study of a face, not a portrait of a known sitter.":'Это «трони» — этюд лица, а не портрет известной модели.',
'Johannes Vermeer':'Ян Вермеер','Dutch Golden Age':'Золотой век Голландии','Mauritshuis, The Hague':'Маурицхёйс, Гаага',
'The Kiss':'Поцелуй','Klimt used real gold leaf on the canvas.':'Климт использовал на холсте настоящее сусальное золото.','Gustav Klimt':'Густав Климт','Art Nouveau':'Модерн','Belvedere, Vienna':'Бельведер, Вена','Austria':'Австрия',
'The Birth of Venus':'Рождение Венеры','Venus arrives on a giant scallop shell, blown ashore by the winds.':'Венеру на огромной раковине гребешка ветры несут к берегу.',
'Sandro Botticelli':'Сандро Боттичелли','Uffizi, Florence':'Галерея Уффици, Флоренция',
'Impression, Sunrise':'Впечатление. Восходящее солнце','This painting gave the Impressionist movement its name.':'Эта картина дала имя импрессионизму.','Musée Marmottan Monet, Paris':'Музей Мармоттан-Моне, Париж',
'The Night Watch':'Ночной дозор',"It isn't a night scene: darkened varnish earned it the nickname.":'Это не ночная сцена: прозвище появилось из-за потемневшего лака.',
'Rembrandt':'Рембрандт','Rijksmuseum, Amsterdam':'Рейксмюсеум, Амстердам',
'Henri Matisse':'Анри Матисс','Pablo Picasso':'Пабло Пикассо','Robert Delaunay':'Робер Делоне','Pierre-Auguste Renoir':'Пьер Огюст Ренуар','Paul Cézanne':'Поль Сезанн','Paul Gauguin':'Поль Гоген','Edgar Degas':'Эдгар Дега','Georges Seurat':'Жорж Сёра',
'Utagawa Hiroshige':'Утагава Хиросигэ','Kitagawa Utamaro':'Китагава Утамаро','Utagawa Kuniyoshi':'Утагава Куниёси','Raphael':'Рафаэль','Titian':'Тициан',
'Cubism':'Кубизм','Baroque':'Барокко','National Gallery, London':'Национальная галерея, Лондон',"Musée d'Orsay, Paris":'Музей Орсе, Париж','Prado, Madrid':'Прадо, Мадрид','Spain':'Испания','Germany':'Германия'
}};
window.GAME={name:'ColorGallery', saveKey:'colorgallery', firstProper:'kandinsky',
  logo:'img/logo-hero.jpg', shareLogo:'img/logo-card.jpg', levels:LEVELS, quiz:QUIZ, strings:STRINGS,
  // Home screen is a museum hall; rooms group consecutive pictures in level order.
  hall:{rooms:[{name:'Shapes and lines',count:3},{name:'Sun and stars',count:3},{name:'Water and sky',count:3},{name:'The yellow room',count:1}]}};
})();
